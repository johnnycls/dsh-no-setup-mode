      ...
      apply(ctx) {
        ...
        function MinimalComposer(props) {
          ...
          return React.createElement(React.Fragment, null,
            ...
            balance !== undefined && balance !== null && balance.ok === true
              ? React.createElement('div', {
              ...
              : balance !== undefined && balance !== null && balance.ok === false && balance.error !== undefined
                ? React.createElement('div', {
                  style: { padding: '2px 24px 12px', display: 'flex', justifyContent: 'flex-end', alignItems: 'center', fontSize: 12, lineHeight: '18px', color: 'var(--dsw-alias-label-secondary)' },
                },
